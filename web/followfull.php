<?php
require_once(__DIR__."/templates/lang_functions.php");
            ...
            <tr>
                <td class="submenu" colspan="2">
                    <table border="0" cellpadding="0" cellspacing="1" style="font-size: 14px">
                        <tr>
                            <td><a href="index.php?lang=<?=$lang?>&amp;"><?=$_CHOOSECMP?></a>
                                >> <?=$currentComp->CompName()?> [<?=$currentComp->CompDate()?>]
                            </td>
                            <td>|</td>
                            <td><a href="https://liveresults.github.io/documentation/"
                                   target="_blank"><?=$_FORORGANIZERS?></a></td>
                            <td>|</td>
                            <td><a href="https://liveresults.github.io/documentation/#developer"
                                   target="_blank"><?=$_FORDEVELOPERS?></a></td>
                        </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <tr>
                        <td valign=top>
							<?php if (!isset($_GET['comp'])) {
								...
								?>
								<?php if (!$showPath) { ?>
                                    <h1 class="categoriesheader"
                                        style="margin-bottom: 4px; color: black"><?=$currentComp->CompName()?>
                                        [<?=$currentComp->CompDate()?>]</h1>
								<?php } ?>
								<?php if (!$isSingleClass && !$isSingleClub) { ?>
                                    <div id="langchooser">
	                                    <?=get_language_chooser("?comp=".$_GET["comp"], $lang)?>
                                    </div>
								<?php } ?>
								<?php if ($showLastPassings) { ?>
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                           style="background-color:#555556; color:#FFF; padding: 10px; margin-top: 3px;border-radius: 5px">
                                        <tr>
                                            <!--Customized logo -->
                                            <!--<td width="161">
                                            ...
                                            <td valign="top" style="padding-left: 5px; width: 200px; text-align:right">
                                                <span id="setAutomaticUpdateText"><b><?=$_AUTOUPDATE?>:</b> <?=$_ON?> | <a
                                                            href="javascript:LiveResults.Instance.setAutomaticUpdate(false);"><?=$_OFF?></a></span><br>
                                                <b><?=$_TEXTSIZE?>:</b> <a
                                                        href="javascript:changeFontSize(1);"><?=$_LARGER?></a> | <a
                                                        href="javascript:changeFontSize(-1);"><?=$_SMALLER?></a><br><br>
                                                <a href="dok/help.php?lang=<?=$lang?>"
                                                   target="_blank"><?=$_INSTRUCTIONSHELP?></a>
                                            </td>
                                        </tr>
                                    </table><br>
								<?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <div><span id="resultsHeader"
                                                       style="font-size: 14px"><b><?=$_NOCLASSCHOSEN?></b></span><span
                                                        style="margin-left: 10px"><?php if (!$isSingleClass) { ?><a
                                                            href="javascript:LiveResults.Instance.newWin()"
                                                            style="text-decoration: none"><img class="eI"
                                                                                               style="vertical-align: middle"
                                                                                               src="images/cleardot.gif"
                                                                                               alt="<?=$_OPENINNEWWINDOW?>"
                                                                                               border="0"
                                                                                               title="<?=$_OPENINNEWWINDOW?>"> <?=$_OPENINNEWWINDOW?>
                                                        </a> <?php } ?><span id="txtResetSorting"></span></span></div>
...
//document.write('<a class="twitter-timeline" href="https://twitter.com/tunapeter/lists/ol-liveresults?widgetId=591685055564636161&amp;chrome=noheader&amp;width=400">Related Tweets</a>');
						...
						<?php if ($currentComp->HasVideo()) { ?>
                            <td valign="top" style="padding: 5px">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                       style="background-color:#000000; color:#FFF; padding: 10px; margin-top: 10px">
                                    <tr>
